                        ...
                        a = void 0 === a || "" === a ? c.delay : a, d = 0, f = setInterval(function() {
                            if (d += 10, d >= a && e === !1) {
                                ...
                                "top" === n ? (c = i.offset().top - o - g, f = i.offset().left + j / 2 - p / 2, h = b(f, c, p, o), q = "-10px", l.css({
                                    ...
                                    marginTop: o / 2,
                                    marginLeft: "0px"
                                })) : (c = i.offset().top + i.outerHeight() + g, f = i.offset().left + j / 2 - p / 2, h = b(f, c, p, o), q = "+10px", l.css({
                                    marginLeft: p / 2 - l.width() / 2
                                })), k.css({
                                    top: h.y,
                                    left: h.x
            ...
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    ...
                    var e, f, g, h = a(this),
                        ...
                        j = i.find("li"),
                        k = i.find(".active").index(); - 1 != k && (e = j.eq(k)), h.hasClass("fullscreen") || (h.height(b.indicators ? b.height + 40 : b.height), i.height(b.height)), j.find(".caption").each(function() {
                        c(a(this), 0)
